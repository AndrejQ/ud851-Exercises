...
implements LoaderManager.LoaderCallbacks<String>{
    ...
    final int GITHUB_SEARCH_LOADER = 100;
    ...
    private void makeGithubSearchQuery() {
        ...
        Loader<String> searchLoader = loaderManager.getLoader(GITHUB_SEARCH_LOADER);
